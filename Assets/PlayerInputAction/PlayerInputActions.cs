...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    // УБРАН Assert из финализатора
    ~@PlayerInputActions()
    {
        // Просто вызываем Dispose если он не был вызван явно
        Dispose();
    }
    ...
    public void Dispose()
    {
        // Отключаем все перед уничтожением
        if (m_Player != null && m_Player.enabled)
        {
            m_Player.Disable();
        }
        
        // Уничтожаем asset только если он существует
        if (asset != null)
        {
